...
\makeatletter
\newtcbtheorem[list inside=qs]{question}{Question}{enhanced,
	breakable,
	colback=white,
...
\usetikzlibrary{arrows,calc,shadows.blur,positioning,tikzmark,backgrounds,shapes}
\tcbuselibrary{skins}
\newtcolorbox{note}[1][]{%
	enhanced jigsaw,
...
% Matrix Environments
%================================
\newenvironment{redmatrix}[1]{\left[\array{@{}#1@{}}}{\endarray\right]}
\newenvironment{ropmatrix}
	{\array{@{}c@{}}}
	{\endarray}
\newcommand\opone[2]{\xrightarrow{(#1) \times r_#2}}
\newcommand\optwo[4]{\xrightarrow{r_#1{}#2{} #3r_#4}}
\newcommand\opswap[2]{\xrightarrow{r_#1 \leftrightarrow r_#2}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% SELF MADE COMMANDS
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\makeatletter
\def\thischaptertitle{}\def\thischapternumber{}\def\thischapterpage{}
\newtoggle{noFigs}

\apptocmd{\@chapter}{\gdef\thischaptertitle{#1}\gdef\thischapternumber{\thechapter}\gdef\thischapterpage{\thepage}%
	...
	\AtBeginEnvironment{figure}{%
		\iftoggle{noFigs}{
			\addtocontents{lof}{\protect\contentsline {chapter}%
				{\protect\numberline {\thischapternumber} {\thischaptertitle}}{\thischapterpage}{} }
...
\definecolor{codeteal}{rgb}{0.08, 0.59, 0.49}
...
\lstdefinestyle{mystyle}{
	...
	basicstyle=\ttfamily\footnotesize\color{codeteal},
...
\lstdefinelanguage{JavaScript}{
	...
	ndkeywordstyle=\color{codeteal}\bfseries,
